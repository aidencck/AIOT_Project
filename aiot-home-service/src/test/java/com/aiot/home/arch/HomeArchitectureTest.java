...
class HomeArchitectureTest {
    ...
    static final ArchRule only_repositories_should_depend_on_mapper =
            noClasses().that().resideOutsideOfPackage("..repository..")
                    .should().dependOnClassesThat().resideInAnyPackage("com.aiot.home.mapper..");

    @ArchTest
    static final ArchRule home_should_not_depend_on_other_services =
