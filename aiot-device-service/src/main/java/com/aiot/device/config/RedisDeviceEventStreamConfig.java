...
public class RedisDeviceEventStreamConfig {
    ...
    public StreamMessageListenerContainer<String, MapRecord<String, String, String>> deviceEventStreamContainer(
        ...
        Subscription subscription = container.receive(
                ...
                (StreamListener<String, MapRecord<String, String, String>>) Objects.requireNonNull(subscriber)
        );
        log.info("DeviceService stream consumer started, stream={}, group={}, consumer={}, active={}",
