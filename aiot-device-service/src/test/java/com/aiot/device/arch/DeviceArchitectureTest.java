...
class DeviceArchitectureTest {
    ...
    static final ArchRule only_repositories_should_depend_on_mapper =
            noClasses().that().resideOutsideOfPackage("..repository..")
                    .should().dependOnClassesThat().resideInAnyPackage("com.aiot.device.mapper..");

    @ArchTest
    static final ArchRule device_should_not_depend_on_other_services =
